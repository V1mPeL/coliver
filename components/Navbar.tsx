...
//   // Проста перевірка наявності токена
//   useEffect(() => {
//     const checkAuth = () => {
//       const token = Cookies.get('jwt_token'); // Замініть на вашу назву cookie з токеном
//       setIsUser(!!token); // Перетворює token на булеве значення (true якщо є, false якщо немає)
//     };
...
//   const handleLogout = () => {
//     // Встановлюємо термін дії cookie на 0 (видаляємо)
